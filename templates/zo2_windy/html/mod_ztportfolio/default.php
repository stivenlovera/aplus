...
<div class="portfolio-wrap">
    ...
    <div class="portfolio-header-small-device">
        <h2><?php echo(JText::_('MOD_ZTPORTFOLIO_FEATURE_PROJECTS')); ?></h2>
        <div class="portfolio-header-center-right">
            <span data-filter="all" class="zt_filter filter-all active"><?php echo(JText::_('MOD_ZTPORTFOLIO_ALL_CATEGORY')); ?></span>
                        ...
                        <div class="zt-portfolio-item">
                            <div class="zt-portfolio-thumb">
                                <a href="<?php echo(ModZtPortfolioHelper::getPortfolioUrl($portfolio)); ?>">
                                    ...
                                    <img alt="<?php echo($portfolio['title']); ?>" width="800" height="600" src="<?php echo ModZtPortfolioHelper::getUrl($portfolio['image']);?>" />
                                </a>
                                <div class="wrap-more-info">
<!--                                    <h5 class="list-cat"> <a href="#" rel="tag"></a></h5>-->
                            <a href="<?php echo JRoute::_('index.php?option=com_ztportfolio&view=item&id='.$portfolio['ztportfolio_item_id'].':'.$portfolio['alias'] . '&Itemid=139');  ?>" class="ztwindy-project" title="<?php echo($portfolio['title']); ?>"> View Project </a>
                                </div>
                            </div>
        ...
        jQuery(window).load(function () {
            ...
            function bindEvent(container){
                ...
                $('.zt_filter').click(function () {
                    ...
                    //$('h5.list-cat a').html($(this).data('filter'));
