...
class VirtueMartViewCart extends VmView
{
    ...
    public function display($tpl = null)
    {
        ...
        $document->addScript(ZtonepagePath::getInstance()->getUrl('Ztonepage://assets/js/zt.onpagecheckout.js'));
        $document->addStyleSheet(ZtonepagePath::getInstance()->getUrl('Ztonepage://assets/css/style.css'));
