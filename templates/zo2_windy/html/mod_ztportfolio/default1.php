...
<div class="portfolio-wrap">
    <div class="portfolio-header">
            ...
            <div class="portfolio-header-center-right project-filter" style="text-align: left;">
    ...
    <div class="portfolio-content row" id="portfolio-content-project">
                ...
                <div class="<?php echo(implode(' ', $class));  ?> gird-common all col-md-<?php echo 12/$column ?>" > 
                    <div class="zt-portfolio-item">
                        ...
                        <div class="zt-portfolio-info">
                            <h3 style="color: #fff; font-size:18px;font-weight: 500;" class="zt-portfolio-title"><?php echo($portfolio['title']); ?></h3><br/>
                             <a class="view-project" href="<?php echo(ModZtPortfolioHelper::getPortfolioUrl($portfolio)); ?>">View Project</a>
                        </div>
                    </div>                    
                </div>
            <?php endforeach; ?>
