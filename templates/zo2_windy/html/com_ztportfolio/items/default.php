		...
		<?php foreach ($this->items as $this->item) { ?>
			...
			<div class="zt-portfolio-item all <?php echo $groups; ?>">
				...
				<div class="zt-portfolio-overlay-wrapper clearfix">
					...
					<div class="zt-portfolio-info-button">
						<h3 class="project-title"><?php echo $this->item->title; ?></h3>
						<br/>
						<a class="prject-button-view" href="<?php echo $this->item->url; ?>" class="view-project">VIEW PROJECT</a>
					</div>
 
				</div>
				
				<?php if($layout_type=='default' and 1==0) { ?>
